...
<template>
    <!-- <section></section> -->
    <AppBar @register-clicked="toggleRegisterModal" @update:drawer="setDrawer" />
        ...
        <div class="drawer-content flex flex-col h-full">
            ...
            <nav class="menu bg-gray-100 p-2 rounded-md">
                <section class="menu-section">
                    <ul class="menu-items">
                        <Link class="menu-item flex items-center" href="/">
                        ...
                        <Link href="/candidates" class="menu-item flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="w-6 h-6">
                            <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <Link href="/jobs" class="menu-item flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="w-6 h-6">
                            <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <Link href="/organization" class="menu-item flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="w-6 h-6">
                            <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <Link href="/about" class="menu-item flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="w-6 h-6">
                            <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <Link href="/contact" class="menu-item flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="w-6 h-6">
                            <path stroke-linecap="round" stroke-linejoin="round"
    ...
    <input class="modal-state" id="register-modal" type="checkbox" :checked="registerModal" @change="toggleRegisterModal" />
    <div class="modal w-screen">
        <label class="modal-overlay" for="register-modal"></label>
        <div class="modal-content flex flex-col gap-5 max-w-3xl">
            <label for="register-modal" class="btn btn-sm btn-circle btn-ghost absolute right-2 top-2">✕</label>
            <h2 class="text-xl text-center">Register As</h2>

            <section class="grid md:grid-cols-2 items-center  gap-10 p-5">
                <section class="border-b-2 mx-auto">
                    <Link :href="candidateRegisterLink" class="flex justify-around">
                       <h3 class="text-xl mr-2">Candidate</h3>
                ...
                <section class="border-b-2 mx-auto">
                    <Link :href="orgRepRegisterLink" class="flex justify-around">
                       <h3 class="text-xl mr-2">Organization Representative</h3>
                       <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3" />
                        </svg>
                    </Link>
