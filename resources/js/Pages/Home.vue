...
<template>
    ...
    <div class="container mx-auto px-6 md:px-12 xl:px-32 pt-40 z-50">
        
      <div class="text-center text-gray-800">
        
        <div class="block rounded-lg shadow-lg px-6 py-12 md:py-8 md:px-12" style="background-color: hsla(0, 0%, 100%, 0.8);backdrop-filter: saturate(200%) blur(25px);">
            <div class="aspect-square rounded bg-gray-900 w-56 m-auto mb-6 flex justify-center items-center text-white">logo image can go in this div</div>
